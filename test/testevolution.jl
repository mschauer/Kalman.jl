...
X = @inferred trace(DynamicIterators.Sample(LinearEvolution(Φ, Gaussian(b, Q))), 0 => x0, endtime(10000))
...
Random.seed!(11)
X = @inferred trace(DynamicIterators.Sample(LinearEvolution(Φ, Gaussian(b, Q))), 0 => x0, endtime(10))
Y = Any[0 => x0]
Random.seed!(11)
